...
OBJS += \
./packages/kawaii-mqtt-latest/network/nettype_tcp.o \
./packages/kawaii-mqtt-latest/network/nettype_tls.o \
./packages/kawaii-mqtt-latest/network/network.o 

C_DEPS += \
./packages/kawaii-mqtt-latest/network/nettype_tcp.d \
./packages/kawaii-mqtt-latest/network/nettype_tls.d \
./packages/kawaii-mqtt-latest/network/network.d 


# Each subdirectory must supply rules for building sources it contributes
packages/kawaii-mqtt-latest/network/%.o: ../packages/kawaii-mqtt-latest/network/%.c
